...
From this picture, we can see that the assembly code is moving parameter into register in order to call function fun2. The relationship between parameter and registers are shown below:
...
From this picture, we can see that the assembly code is moving the return value of func2 into register in order to call function fun2. The relationship between function's return value and registers are shown below:
